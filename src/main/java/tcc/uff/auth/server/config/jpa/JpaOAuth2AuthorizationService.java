...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        Optional<AuthorizationDocument> result;
        if (tokenType == null) {
    ...
    private OAuth2Authorization toObject(AuthorizationDocument entity) {
    ...
    private AuthorizationDocument toEntity(OAuth2Authorization authorization) {
        AuthorizationDocument entity = new AuthorizationDocument();
